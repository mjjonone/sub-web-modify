...
export default {
  data() {
    return {
      ...
      form: {
        sourceSubUrl: "",
        clientType: "",
        customBackend: this.getUrlParam() == "" ? "https://tediousunrealisticglueware.11199911.repl.co" : this.getUrlParam(),
  ...
  methods: {
    ...
    tanchuang() {
      this.$alert(`<div style="text-align:center;font-size:15px"><strong><span style="font-size:20px">github：</span><span><a href="https://github.com/mjjonone" target="_blank" style="color:red;font-size:20px;text-decoration:none">点击加入</a></span></strong></br><strong><span style="font-size:20px">Hello World（<span style="color:blue">你好</span>）：</span><span><a href="https://subweb-moec.onrender.com/" style="color:green;font-size:20px;text-decoration:none">进入</a></span></strong></br><strong><span style="font-size:20px">大海（<span style="color:blue">世界</span>）：</span><span><a href="https://subweb-moec.onrender.com/" style="color:red;font-size:20px;text-decoration:none">点击进入</a></span></strong></br><strong><span style="font-size:20px">森林：</span><span><a href="https://subweb-moec.onrender.com/" style="color:green;font-size:20px;text-decoration:none">点击查看</a></span></strong></br><strong><span style="font-size:20px">无：</span><span><a href="https://subweb-moec.onrender.com/" style="color:red;font-size:20px;text-decoration:none">点击查看</a></span></strong></br>MJJ！</br></div>`, '信息面板', {
